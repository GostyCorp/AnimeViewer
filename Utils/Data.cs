...
public abstract class Data
{
	...
	public static void Init(bool reset = false)
	{
		...
		OpenSqLite();
		SQLiteCommand liteCommand = new SQLiteCommand(commandText: File.ReadAllText("Script/db.sql"), Sqlite);
	...
	public static HtmlNodeCollection GetScrapWebSite(string url, string xPath)
	{
		...
		Uri.TryCreate(url, UriKind.Absolute, result: out Uri uriResult);
		if(uriResult == null)
		{
